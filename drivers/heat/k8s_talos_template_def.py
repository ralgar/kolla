...
class K8sTalosTemplateDefinition(k8s_template_def.K8sTemplateDefinition):
    """Kubernetes template for a Talos VM."""

    def __init__(self):
        super(K8sTalosTemplateDefinition, self).__init__()
    ...
    def get_params(self, context, cluster_template, cluster, **kwargs):
        ...
        return super(K8sTalosTemplateDefinition,
